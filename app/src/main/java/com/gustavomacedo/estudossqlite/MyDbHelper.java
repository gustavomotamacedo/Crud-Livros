...
public class MyDbHelper extends SQLiteOpenHelper {
    ...
    public void addBook(String title, String author, int pages) {
        ...
        if (result == -1) {
            Toast.makeText(context, "Operação mal sucedida", Toast.LENGTH_SHORT).show();
        } else {
    ...
    public void updateDataById(String id, String title, String author, String pages) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
    ...
    public void delete(String id) {
        ...
        if (result == -1) {
            ...
            Toast.makeText(context, "Livro deletado", Toast.LENGTH_SHORT).show();
        }
    }
